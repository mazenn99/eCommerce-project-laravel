                                ...
                                <div class="card-body pb-0">
                                    <div class="row">
                                        ...
                                        <div class="col-5 pl-2">
                                            <h4>{{trans('dashboard/index.total_price')}}</h4>
                            ...
                            <div class="card-content">
                                <div class="card-body pb-0">
                                    <div class="row">
                                        ...
                                        <div class="col-5 pl-2">
                                            <h4>{{trans('dashboard/index.total_order')}}</h4>
                            ...
                            <div class="card-content">
                                <div class="card-body pb-0">
                                    <div class="row">
                                        ...
                                        <div class="col-5 pl-2">
                                            <h4>{{trans('dashboard/index.product_count')}}</h4>
                            ...
                            <div class="card-content">
                                <div class="card-body pb-0">
                                    <div class="row">
                                        ...
                                        <div class="col-5 pl-2">
                                            <h4>{{trans('dashboard/index.customer_count')}}</h4>
                                            <h6 class="text-muted">Balance</h6>
                                        </div>
                                        <div class="col-5 text-right">
                                            <h4>$1.2</h4>
                    ...
                    <div class="col-12 col-xl-8">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">{{trans('dashboard/index.last_order')}}</h4>
...
{{--                                </div>--}}
                            ...
                            <div class="card-content">
                                <div class="table-responsive">
                                    <table class="table table-de mb-0">
                                        <thead>
                                        <tr>
                                            <th>{{trans('dashboard/index.order_number')}}</th>
                                            <th>{{trans('dashboard/index.client')}}</th>
                                            <th>{{trans('dashboard/index.price')}}</th>
                                            <th>{{trans('dashboard/index.status')}}</th>
                                            <th>{{trans('dashboard/index.total')}}</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <tr class="bg-success bg-lighten-5">
                                            <td>2131</td>
                                            <td><i class="cc BTC-alt"></i> mazen</td>
                                            <td>$ 4762.53</td>
                                            <td>shipped</td>
                                            <td>3444</td>
                                        </tr>
                    ...
                    <div class="col-12 col-xl-4">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">{{trans('dashboard/index.ratting')}}</h4>
                                <a class="heading-elements-toggle"><i class="la la-ellipsis-v font-medium-3"></i></a>
                                {{--                                <div class="heading-elements">--}}
                                {{--                                    <p class="text-muted">Total BTC available: 6542.56585</p>--}}
                                {{--                                </div>--}}
                            ...
                            <div class="card-content">
                                <div class="table-responsive">
                                    <table class="table table-de mb-0">
                                        ...
                                        <tr>
                                            <th>{{trans('dashboard/index.client')}}</th>
                                            <th>{{trans('dashboard/index.product')}}</th>
                                            <th>{{trans('dashboard/index.rate')}}</th>
                                        ...
                                        <tr class="bg-success bg-lighten-5">
                                            <td>mazen</td>
                                            <td><i class="cc BTC-alt"></i> watch </td>
                                            <td>5</td>
                                        </tr>
                                        </tbody>
                                    </table>
