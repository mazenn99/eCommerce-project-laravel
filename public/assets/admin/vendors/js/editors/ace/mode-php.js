...
var PhpLangHighlightRules = function() {
    ...
    var builtinFunctions = lang.arrayToMap(
        ...
        'imap_unsubscribe|imap_utf7_decode|imap_utf7_encode|imap_utf8|implementsinterface|implode|import_request_variables|in_array|includes|' +
    ...
    var languageConstructs = lang.arrayToMap(
        ('die|echo|empty|exit|eval|includes|include_once|isset|list|require|require_once|return|print|unset').split('|')
    );
...
var functionMap = {
    ...
    "openssl_pkcs7_decrypt": [
        ...
        "Decrypts the S\/MIME message in the file name infilename and output the results to the file name outfilename.  recipcert is a CERT for one of the recipients. recipkey specifies the private key matching recipcert, if recipcert does not includes the key"
    ],
    ...
    "openssl_pkcs7_sign": [
        ...
        "Signs the MIME message in the file named infile with signcert\/signkey and output the result to file name outfile. headers lists plain text headers to exclude from the signed portion of the message, and should includes to, from and subject as a minimum"
    ],
