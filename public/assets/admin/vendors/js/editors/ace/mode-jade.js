...
var ScssHighlightRules = function() {
    ...
    var keywords = lang.arrayToMap(
        ("@mixin|@extend|@includes|@import|@media|@debug|@warn|@if|@for|@each|@while|@else|@font-face|@-webkit-keyframes|if|and|!default|module|def|end|declare").split("|")
    )
...
var JadeHighlightRules = function() {
    ...
    "start": [
        {
            token: "keyword.control.import.includes.jade",
            regex: "\\s*\\binclude\\b"
        },
        {
