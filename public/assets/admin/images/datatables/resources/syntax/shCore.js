...
function eachLine(str, callback)
{
    ...
    // includes \r to enable copy-paste on windows (ie8) without getting everything on one line
    return lines.join('\r\n');
};
...
function processUrls(code)
{
    ...
    return code.replace(sh.regexLib.url, function(m)
    {
        ...
        // We includes &lt; and &gt; in the URL for the common cases like <http://google.com>
...
;(function()
{
    ...
    function Brush()
    {
        ...
        var keywords =  'abstract and array as break case catch cfunction class clone const continue declare default die do ' +
                        ...
                        'function global goto if implements includes include_once interface instanceof insteadof namespace new ' +
